package in.greatlearning.EmployeeManagement.security;
...
import in.greatlearning.EmployeeManagement.service.UserDetailsServiceImpl;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers("/", "/employees/showFormForAdd", "/employees/save", "/employees/403")

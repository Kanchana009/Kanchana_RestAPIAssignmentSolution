...
<body>
	...
	<div class="container">
		...
		<form action="/EmployeesManagement/employees/search" class="form-inline">

			<!-- Add a button -->
			<a href="/EmployeesManagement/employees/showFormForAdd"
				...
				<c:forEach items="${Employees}" var="tempEmployee">
					<tr>
						...
						<td>
							...
							href="/EmployeesManagement/employees/showFormForUpdate?employeeId=${tempEmployee.id}"
							class="btn btn-info btn-sm"> Update </a> <!-- Add "delete" button/link -->
							<a href="/EmployeesManagement/employees/delete?employeeId=${tempEmployee.id}"
